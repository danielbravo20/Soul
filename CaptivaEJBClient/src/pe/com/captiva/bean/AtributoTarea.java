...
public class AtributoTarea extends AtributoBean{
	...
	private CampoSQLTareaBean campoSQLTarea;
	...
	public CampoSQLTareaBean getCampoSQLTarea() {
		return campoSQLTarea;
	}
	public void setCampoSQLTarea(CampoSQLTareaBean campoSQLTarea) {
