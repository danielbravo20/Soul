...
public abstract class PreEmisionEntregarCartaFianzaV1Servicio extends BaseTareaServicioImpl implements BaseTareaServicioLocal{
	...
	public TareaPlantilla proximaTareaCompletar(Tarea tarea) throws Exception {
		...
		tareaPlantilla.setCodigoTareaPlantilla(9);
		tareaPlantilla.setAleas("EmisionAutorizarReimpresionV1");
		tareaPlantilla.setEstado(1);
		tareaPlantilla.setNombre("AUTORIZAR REIMPRESION");
