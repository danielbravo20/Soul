...
public class TareaAtrRechazar implements java.io.Serializable {
	...
	public TareaAtrRechazar(TareaAtrRechazarId id, Atributo atributo, Tarea tarea, int codProceso) {
		this.id = id;
	...
	public TareaAtrRechazar(TareaAtrRechazarId id, Atributo atributo, Tarea tarea, int codProceso, String javValOmision,
