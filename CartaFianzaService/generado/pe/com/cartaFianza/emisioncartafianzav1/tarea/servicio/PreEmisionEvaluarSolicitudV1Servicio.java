...
public abstract class PreEmisionEvaluarSolicitudV1Servicio extends BaseTareaServicioImpl implements BaseTareaServicioLocal{
	...
	public TareaPlantilla proximaTareaCompletar(Tarea tarea) throws Exception {
		...
		tareaPlantilla.setAleas("EmisionAprobarSolicitudV1");
