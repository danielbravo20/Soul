...
/**
 * MaeCatalogo generated by hbm2java
 */
@Entity
@Table(name = "mae_catalogo", schema = "soul")
public class MaeCatalogo implements java.io.Serializable {

	private MaeCatalogoId id;
	...
	public MaeCatalogo(MaeCatalogoId id, char cabecera) {
		this.id = id;
		this.cabecera = cabecera;
	}

	public MaeCatalogo(MaeCatalogoId id, Proyecto proyecto, String valor1, String valor2, String descripcion,
	...
	public MaeCatalogoId getId() {
		return this.id;
	}

	public void setId(MaeCatalogoId id) {
		this.id = id;
	}
