// v1.0
portal.directive('nxRegla', ['$filter', function ($filter) {
    return {
        require: '?ngModel',
...
portal.directive('maximaLongitud', function() { // maxima-longitud
  return {
    require: 'ngModel',
...
portal.directive('showErrors', function($timeout, showErrorsConfig) {
...
portal.provider('showErrorsConfig', function () {
	var _showSuccess;
	_showSuccess = false;
