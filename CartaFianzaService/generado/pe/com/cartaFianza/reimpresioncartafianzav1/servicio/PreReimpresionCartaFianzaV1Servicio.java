...
public abstract class PreReimpresionCartaFianzaV1Servicio extends BaseProcesoServicioImpl implements BaseProcesoServicioLocal{

	public static final long   PROCESO_CODIGO_PLANTILLA_PROCESO = 7;
	public static final String PROCESO_NOMBRE = "BE - REIMPRESION DE CARTA FIANZA";
	public static final String PROCESO_ALEAS = "ReimpresionCartaFianzaV1";
	...
	public TareaPlantilla definirProximaTarea(Proceso proceso) throws Exception{
		...
		plantilla.setCodigoTareaPlantilla(705);
		plantilla.setNombre("AUTORIZAR REIMPRESION");
		plantilla.setAleas("ReimpresionAutorizarReimpresionV1");
