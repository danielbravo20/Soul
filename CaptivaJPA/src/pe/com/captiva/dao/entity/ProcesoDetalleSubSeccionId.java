...
public class ProcesoDetalleSubSeccionId implements java.io.Serializable {
	...
	public ProcesoDetalleSubSeccionId(String codSeccion, int codSubSeccion, String nombre) {
		this.codSeccion = codSeccion;
		this.codSubSeccion = codSubSeccion;
		this.nombre = nombre;
	}

	public ProcesoDetalleSubSeccionId(Integer codProceso, String codSeccion, int codSubSeccion, String nombre) {
