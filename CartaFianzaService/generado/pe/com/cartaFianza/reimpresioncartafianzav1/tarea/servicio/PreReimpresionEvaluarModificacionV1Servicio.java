package pe.com.cartaFianza.reimpresioncartafianzav1.tarea.servicio;
...
public abstract class PreReimpresionEvaluarModificacionV1Servicio extends BaseTareaServicioImpl implements BaseTareaServicioLocal{
	...
	public TareaPlantilla proximaTareaCompletar(Tarea tarea) throws Exception {
		...
		tareaPlantilla.setCodigoTareaPlantilla(702);
		tareaPlantilla.setAleas("ReimpresionEvaluarModificacionV1");
		tareaPlantilla.setEstado(1);
		tareaPlantilla.setNombre("EVALUAR MODIFICACION");
