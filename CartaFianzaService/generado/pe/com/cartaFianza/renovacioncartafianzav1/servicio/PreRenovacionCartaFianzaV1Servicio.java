...
public abstract class PreRenovacionCartaFianzaV1Servicio extends BaseProcesoServicioImpl implements BaseProcesoServicioLocal{

	public static final long   PROCESO_CODIGO_PLANTILLA_PROCESO = 3;
	public static final String PROCESO_NOMBRE = "BE - RENOVACIÓN DE CARTA FIANZA";
	public static final String PROCESO_ALEAS = "RenovacionCartaFianzaV1";
	...
	public TareaPlantilla definirProximaTarea(Proceso proceso) throws Exception{
		...
		plantilla.setCodigoTareaPlantilla(307);
		plantilla.setNombre("SUBSANAR OBSERVACIONES VISADO");
		plantilla.setAleas("RenovacionSubsanarObservacionesVisadoV1");
