...
public class TareaAtrCancelar implements java.io.Serializable {
	...
	public TareaAtrCancelar(TareaAtrCancelarId id, Atributo atributo, Tarea tarea, int codProceso) {
		this.id = id;
	...
	public TareaAtrCancelar(TareaAtrCancelarId id, Atributo atributo, Tarea tarea, int codProceso, String javValOmision,
