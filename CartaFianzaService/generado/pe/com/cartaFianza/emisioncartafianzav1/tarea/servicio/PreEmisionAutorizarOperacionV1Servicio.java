...
public abstract class PreEmisionAutorizarOperacionV1Servicio extends BaseTareaServicioImpl implements BaseTareaServicioLocal{
	...
	public TareaPlantilla proximaTareaCompletar(Tarea tarea) throws Exception {
		...
		tareaPlantilla.setCodigoTareaPlantilla(7);
		tareaPlantilla.setAleas("EmisionImprimirValoradoV1");
		tareaPlantilla.setEstado(1);
		tareaPlantilla.setNombre("IMPRIMIR VALORADO");
